package org.toskan4134.hytrade.constants;

/**
 * Constants for the HyTrade plugin.
 * Contains all magic numbers, configuration values, and timeouts.
 */
public final class TradeConstants {
    ...
    /** Countdown duration after both accept (3 seconds) */
    public static final long COUNTDOWN_DURATION_MS = 3000;
    ...
    /** Status message reset delay in milliseconds (5 seconds) */
